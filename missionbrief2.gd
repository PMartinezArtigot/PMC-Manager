...
func missioninprogress():
	...
	Global.mission2selected = 1
	if (winchance <= idk):
		Global.currentmissions[squadselected] = [Global.missionlist[Global.arr[1]][10], Global.missionlist[Global.arr[1]][5],
		Global.missionlist[Global.arr[1]][6], Global.missionlist[Global.arr[1]][7], Global.missionlist[Global.arr[1]][8],
		Global.missionlist[Global.arr[1]][9], idk, Global.missionlist[Global.arr[1]][11], true, Global.missionlist[Global.arr[1]][17],
		Global.missionlist[Global.arr[1]][19], Global.missionlist[Global.arr[1]][21]]
	else:
		Global.currentmissions[squadselected] = [Global.missionlist[Global.arr[1]][10], Global.missionlist[Global.arr[1]][5],
		Global.missionlist[Global.arr[1]][6], Global.missionlist[Global.arr[1]][7], Global.missionlist[Global.arr[1]][8],
		Global.missionlist[Global.arr[1]][9], idk, Global.missionlist[Global.arr[1]][11], false]
