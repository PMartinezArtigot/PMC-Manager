...
func soldierinfo(row, btnnum):
	...
	if (str(Global.allsquads[row][btnnum][13]) != "???"):
		$assignsquad.text = "Envíar a \n reservas"
	else:
		$assignsquad.text = "Asignar \n soldado"
...
func disableassign():
	if (Global.unlockedreserve == 1):
		...
		Global.allsquads[5][3][0] != "Vacío" && Global.allsquads[5][4][0] != "Vacío") || (Global.busysquads[selectedsquad] == true)
		|| (Global.allsquads[selectedsquad][selectedsoldier][0] == "Vacío")):
			$assignsquad.disabled = true
		else:
			$assignsquad.disabled = false
	if (Global.unlockedreserve == 2):
		...
		Global.allsquads[5][9][0] != "Vacío") || (Global.busysquads[selectedsquad] == true)
		|| (Global.allsquads[selectedsquad][selectedsoldier][0] == "Vacío")):
			$assignsquad.disabled = true
		else:
			$assignsquad.disabled = false
...
func _on_assignsquad_pressed():
	if ($assignsquad.text == "Asignar \n soldado"):
		#unlocksquads()
		$assignsquadscreen.show() 
		fullsquad()
	if ($assignsquad.text == "Envíar a \n reservas"):
		for i in Global.reserve.size():
			if (Global.reserve[i][0] == "Vacío"):
				Global.reserve[i] = Global.allsquads[selectedsquad][selectedsoldier]
				Global.reserve[i][13] = "???"
				Global.allsquads[selectedsquad][selectedsoldier] = ["Vacío", 0, 100, 0, 0, 0, 0, "F", "F", "F", "F", "F", "Ninguna", "???"]
				clearscreen()
				break
...
func fullsquad():
	for i in (Global.unlockedsquads + 1):
...
func disablesquad(squadnum, disena):
	...
	if (squadnum == 2 && disena == 1):
		$assignsquadscreen/squad3.disabled = true
	...
	if (squadnum == 2 && disena == 0):
		$assignsquadscreen/squad3.disabled = false
...
func clearscreen():
	...
	$ENG.text = "A"
	$ablbl2.text = "???"
	$assquad.text = "Ninguno"
	$assignsquad.disabled = true


func _on_squad_1_pressed():
		for i in Global.squad1.size():
			if (Global.squad1[i][0] == "Vacío"):
				Global.squad1[i] = Global.allsquads[selectedsquad][selectedsoldier]
				Global.squad1[i][13] = "1"
				Global.allsquads[selectedsquad][selectedsoldier] = ["Vacío", 0, 100, 0, 0, 0, 0, "F", "F", "F", "F", "F", "Ninguna", "???"]
				clearscreen()
				$assignsquadscreen.hide()
				break
...
func _on_squad_2_pressed():
		for i in Global.squad2.size():
			if (Global.squad2[i][0] == "Vacío"):
				Global.squad2[i] = Global.allsquads[selectedsquad][selectedsoldier]
				Global.squad2[i][13] = "2"
				Global.allsquads[selectedsquad][selectedsoldier] = ["Vacío", 0, 100, 0, 0, 0, 0, "F", "F", "F", "F", "F", "Ninguna", "???"]
				clearscreen()
				$assignsquadscreen.hide()
				break
...
func _on_squad_3_pressed():
		for i in Global.squad3.size():
			if (Global.squad3[i][0] == "Vacío"):
				Global.squad3[i] = Global.allsquads[selectedsquad][selectedsoldier]
				Global.squad3[i][13] = "3"
				Global.allsquads[selectedsquad][selectedsoldier] = ["Vacío", 0, 100, 0, 0, 0, 0, "F", "F", "F", "F", "F", "Ninguna", "???"]
				clearscreen()
				$assignsquadscreen.hide()
				break
