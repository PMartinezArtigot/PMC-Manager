...
func missioninprogress():
	...
	Global.mission3selected = 1
	if (winchance <= idk):
		Global.currentmissions[squadselected] = [Global.missionlist[Global.arr[2]][10], Global.missionlist[Global.arr[2]][5],
		Global.missionlist[Global.arr[2]][6], Global.missionlist[Global.arr[2]][7], Global.missionlist[Global.arr[2]][8],
		Global.missionlist[Global.arr[2]][9], idk, Global.missionlist[Global.arr[2]][11], true, Global.missionlist[Global.arr[2]][17],
		Global.missionlist[Global.arr[2]][19], Global.missionlist[Global.arr[2]][21]]
	else:
		Global.currentmissions[squadselected] = [Global.missionlist[Global.arr[2]][10], Global.missionlist[Global.arr[2]][5],
		Global.missionlist[Global.arr[2]][6], Global.missionlist[Global.arr[2]][7], Global.missionlist[Global.arr[2]][8],
		Global.missionlist[Global.arr[2]][9], idk, Global.missionlist[Global.arr[2]][11], false]
