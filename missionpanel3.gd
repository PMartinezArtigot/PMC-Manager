...
func broke():
	if ((Global.missionlist[Global.arr[2]][0] > Global.ammo) || (Global.missionlist[Global.arr[2]][1] > Global.ration)
	|| (Global.missionlist[Global.arr[2]][2] > Global.constmats) || (Global.missionlist[Global.arr[2]][3] > Global.parts)
	|| (Global.missionlist[Global.arr[2]][4] > Global.money)):
